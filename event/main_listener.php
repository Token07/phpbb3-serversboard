...
class main_listener implements EventSubscriberInterface
{
    ...
    public function navbar_setup()
    {
        ...
        if ($this->collapse_cat !== null) {
            $this->template->assign_vars([
                ...
                'SERVERSBOARD_COLLAPSE_URL'    => $this->helper->route('phpbb_collapsiblecategories_main_controller', [
    ...
    public function add_permission($event)
    {
        ...
        $permissions['a_serversboard'] = ['lang' => 'ACL_A_SERVERSBOARD', 'cat' => 'misc'];
    ...
    private function setTemplateVars($row)
    {
        ...
        $tmp['LINK'] = $this->helper->route('token07_serversboard_viewdetails', ['id' => $row['server_id']]);
